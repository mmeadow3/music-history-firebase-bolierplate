...
//     $.ajax({
//       url: "https://mux-history-e3.firebaseio.com/.json?orderBy="uid"&equalTo="${userId}"
...
function deleteSong(songId) {
  ...
  ////////telling firebase to look inside "songs"//////////////
}
...
function editSong(songFormObj, songId) {
  console.log("songId in EditSong", songId );  ///////songId is the code given by FB
